		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right main-nav">
					...
					<li><a href="#services">View Jobs</a></li>
					<li><a href="#team">Placed Student</a></li>
					<li><a href="#pricing">Charged Services</a></li>
					<li><a href="Registration.php">Register Now</a></li>
					<li><a href="#" data-toggle="modal" data-target="#modal1" class="btn btn-blue">Sign in/up</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
				...
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
							<h3 class="light white">TechBodhi Solutions.</h3>
							<h1 class="white typed">100% placement is guarantee.</h1>
			...
			<div class="row intro-tables">
				<div class="col-md-4">
					<div class="intro-table intro-table-first">
						<h5 class="white heading">Today's interviews</h5>
						<div class="owl-carousel owl-schedule bottom">
							<div class="item">
								<div class="schedule-row row">
									<div class="col-xs-6">
										<h5 class="regular white">Tejas Gawali</h5>
									</div>
								...
								<div class="schedule-row row">
									<div class="col-xs-6">
										<h5 class="regular white">Abhishek Malpani</h5>
									</div>
									<div class="col-xs-6 text-right">
										<h5 class="white">8:30 - 10:00</h5>
									</div>
								...
								<div class="schedule-row row">
									<div class="col-xs-6">
										<h5 class="regular white">Purushotum Kumar</h5>
									</div>
									<div class="col-xs-6 text-right">
										<h5 class="white">8:30 - 10:00</h5>
									</div>
				...
				<div class="col-md-4">
					<div class="intro-table intro-table-hover">
						<h5 class="white heading hide-hover">Get Premium Membership</h5>
						<div class="bottom">
							<h4 class="white heading small-heading no-margin regular">Register Today</h4>
							<h4 class="white heading small-pt">50% Discount</h4>
	...
	<section id="team" class="section gray-bg">
		<div class="container">
			<div class="row title text-center">
				<h2 class="margin-top">Placed Students</h2>
	...
	<div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content modal-popup">
				...
				<h3 class="white">Sign Login</h3>
				<form name="login" action="../Controllers/checkUser.php" class="popup-form" method="POST">
					<input type="text" class="form-control form-white" id="username" name="username" placeholder="Enter Username">
					<input type="text" class="form-control form-white" id="password" name="password" placeholder="Enter Password">
					...
					<button type="submit" id="logcheck" class="btn btn-submits">Login</button>
				</form>
			</div>
		</div>
	</div>
