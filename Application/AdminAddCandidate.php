...
<div class="row-fluid">
    ...
    <form role="form" id="AdminAddcandidate" method="POST">
...
?>
    <script>
        ...
        {   
            $('form[name=AdminAddcandidate]').submit(function(e) {
                e.preventDefault();
                $.ajax({
                    type: 'POST',
                    cache: false,
                    url: '../Controllers/AdminAddCandidate.inc.php',
                    data: $(this).serialize(),
                    success: function(data){
                        alert(data);
                        $('#AdminAddcandidate')[0].reset();
                    }
                });
            });
        });    
