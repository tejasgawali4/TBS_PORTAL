...
<head>
    <meta charset="UTF-8">
    <title>Tech Bodhi | Dashboard</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta name="description" content="Developed By Tejas Gawali">
    <meta name="keywords" content="Techbodhi, Job Portal, Responsive">
    <!-- bootstrap 3.0.2 -->
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <?php
                            ...
                            echo "<span> $name <i class='caret'></i></span>";
                        ?>
                            ...
                            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                                ...
                                <li class="divider"></li>
                                    ...
                                    <li>
                                        ...
                                        <li>
                                            <a href="../Website/index.php"><i class="fa fa-ban fa-fw pull-right"></i> Logout</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <aside class="left-side sidebar-offcanvas">
                        ...
                        <section class="sidebar">
                            ...
                            <ul class="sidebar-menu">
                                <li>
                                    <a href="UserViewJobPost.php">
                                        <i class="fa fa-gavel"></i> <span>Job Openings</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="UserReferFriend.php">
                                        <i class="fa fa-globe"></i> <span>Refer Friend</span>
                                   </a>
                                </li>
                                <li>
                                    <a href="UserViewAppliedJobs.php">
                                        <i class="fa fa-globe"></i> <span>View Applied Jobs</span>
                                   </a>
                                </li>
